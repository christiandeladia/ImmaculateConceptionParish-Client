...
<head>
    <title>APPLY FOR SICKCALL - ICP </title>
    <meta charset="UTF-8">
        ...
        < Back</a>
            <div class="container">
                ...
                <div class="form-outer">
                    <form method="post" action="services_forms/form_process/sickcall_put.php" method="POST"
                        enctype="multipart/form-data">
                        <div class="page slide-page">
                            <div class="title">Patient's Info:</div>
                            <div class="field">
                                <label class="label" for="patients_name">Patient's Name</label>
                                <input type="text"
                                    ...
                                    class="form-control" name="patients_name" required>
                            </div>
                            ...
                            <div id="completeAddress" style="display: none;">
                                <div class="field">
                                    ...
                                    <input type="text" class="input" id="complete_address" name="complete_address"
                                        required>
                                </div>
                            </div>
                        ...
                        <div class="page">
                            <div class="title">Illness and Contact:</div>
                            <div class="field">
                                <label class="label" for="urgent">Is it urgent? (Sick Person in Danger of Death)</label>
                                <select class="select" name="urgent" required>
                                    <option value="" disabled selected hidden></option>
                            ...
                            <div class="field">
                                <label class="label" for="illness">Illness</label>
                                <input type="text"
                                    onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode === 46 || event.charCode === 32"
                                    class="form-control" name="illness" required>
                            </div>
                            <div class="field">
                                <label class="label" for="can_eat">Can Eat</label>
                                <select class="select" name="can_eat" required>
                                    <option value="" disabled selected hidden></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="field">
                                <label class="label" for="can_speak">Can Speak</label>
                                <select class="select" name="can_speak" required>
                                    <option value="" disabled selected hidden></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="field">
                                ...
                                <input type="text" class="form-control" name="contact_number" maxlength="11" pattern="[0-9]{11}"
