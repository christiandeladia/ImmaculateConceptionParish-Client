...
if (isset($_GET['reference_id'])) {
    ...
    $query = "SELECT * FROM funeral WHERE reference_id = '$orderId' ORDER BY date_added";
...
<head>
    <meta charset="utf-8" />
    <title>View Orders Funeral - ICP</title>
                    ...
                    <div class="col-lg">
                        <div class="card">
                            <div class="card-body p-10">
                                <div style="display: flex; justify-content: space-between;">
                                    <h4 class="p-0 mb-10">Funeral Application Form</h4>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['deceased_fullname']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="age">Age:</label>
                                                <input type="number" class="form-control"
                                                    value="<?= $data[0]['age']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="date_of_death">Date of Death:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= date('M d, Y', strtotime($data[0]['date_of_death'])) ?>"
                                                    disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['civil_status']; ?>" disabled>
                                            </div>

                                            <?php
            if ($data[0]['civil_status'] === "Married") {
                ?>
                                            <div class="form-group col-md">
                                                <label for="spouse_name">Spouse Name:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['spouse_name']; ?>" disabled>
                                            </div>

                                            <div class="form-group col-md">
                                                <label for="number_of_child">Number of Children:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['number_of_child']; ?>" disabled>
                                            </div>
                                            <?php
            }
            ?>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['mother_name']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                ...
                ?>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['relationship']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="contact_number">Contact Number:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['contact_number']; ?>" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['cause_of_death']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="has_sacrament">Has Sacrament:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['has_sacrament']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="burial_place">Burial Place:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['burial_place']; ?>" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['allowed_to_mass']; ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                                <label for="time">Mass Time:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= date('h:m a', strtotime($data[0]['time'])) ?>" disabled>
                                            </div>
                                            <div class="form-group col-md">
                                            ...
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]['mass_location']; ?>" disabled>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="timeline">
                                    ...
                                    <li <?php if ($status >= 2) echo 'class="active"'; ?>>
                                        ...
                                        <p>Your Application <strong
                                                style="color: #007bff"><?php echo $orderId; ?></strong>
                                            was approved, kindly wait for an email.</p>
                                        <p class="text-muted">
                                            <?php if (!empty($notification_dates[0])) echo date('M d, Y g:ia', strtotime($notification_dates[0])); ?>
                                    </li>
