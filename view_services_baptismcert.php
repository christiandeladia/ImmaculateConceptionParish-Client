...
if (isset($_GET['reference_id'])) {
    ...
    $query = "SELECT * FROM binyag_request_certificate WHERE reference_id = '$orderId' ORDER BY date_added";
                    ...
                    <div class="col-lg">
                        <div class="card">
                            <div class="card-body p-10">
                                <div style="display: flex; justify-content: space-between;">
                                    <h4 class="p-0 mb-10">Baptism Certificate Request Form</h4>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control" value="<?= $data[0]["birthdate"] ?>"
                                                    disabled>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]["father_fullname"] ?>" disabled>
                                            </div>

                                            <div class="form-group col-md">
                                                <label for="mother_maidenname">Mother's Maiden Name:</label>
                                                <input type="text" class="form-control"
                                                    value="<?= $data[0]["mother_maidenname"] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                <label for="purpose">Purpose:</label>
                                                <input type="text" class="form-control" value="<?= $data[0]["purpose"] ?>"
                                                    disabled>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="timeline">
                                    ...
                                    <li <?php if ($status >= 2) echo 'class="active"'; ?>>
                                        ...
                                        <p>Your Application <strong
                                                style="color: #007bff"><?php echo $orderId; ?></strong>
                                            was approved. The admin will send a copy of Certificate, kindly wait for an
                                            email.</p>
                                        <p class="text-muted">
                                            <?php if (!empty($notification_dates[0])) echo date('M d, Y g:ia', strtotime($notification_dates[0])); ?>
                                    </li>
