...
if (isset($_GET['reference_id'])) {
    ...
    $query = "SELECT * FROM blessing WHERE reference_id = '$orderId' ORDER BY date_added";
...
<head>
    <meta charset="utf-8" />
    <title>View Application Blessing - ICP</title>
        ...
        <div class="container">
            <div class="main-body">
                ...
                <div class="row">
                    <div class="col-lg">
                        ...
                        <div class="customer-reason">
                            <p><strong> Your Application #<?php echo $orderId; ?> has been Cancelled!</strong><br><strong>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div class="card">
                            ...
                            <div style="display: flex; justify-content: space-between;">
                                <h4 class="p-0 mb-10">Blessing Application Form</h4>
                ...
                <div class="form-group col-md">
                    ...
                    <input type="text" class="form-control" value="<?= $data[0]["place"] ?>" disabled>
                </div>
                <div class="form-group col-md">
                    <label for="owner_name">Owner's Name:</label>
                    <input type="text" class="form-control" value="<?= $data[0]["owner_name"] ?>" disabled>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md">
            ...
            <div class="form-row">
                <div class="form-group col-md">
                    ...
                    <input type="text" class="form-control" value="<?= $data[0]["contact_number"] ?>" disabled>
                </div>
                <div class="form-group col-md">
            ...
            <div class="form-row">
                <div class="form-group col-md">
                    ...
                    <input type="text" class="form-control" value="<?= date('M d, Y', strtotime($data[0]["date"])) ?>" disabled>
                </div>
                <div class="form-group col-md">
                    <label for="time">Time:</label>
                    <input type="text" class="form-control" value="<?= date('h:i a', strtotime($data[0]["time"])) ?>" disabled>
                </div>
            </div>
