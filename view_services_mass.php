...
if (isset($_GET['reference_id'])) {
    ...
    $query = "SELECT * FROM mass WHERE reference_id = '$orderId' ORDER BY date_added";
...
<head>
    <meta charset="utf-8" />
    <title>View Orders Mass - ICP</title>
            ...
            <div class="main-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div class="card">
                            <div class="card-body p-10">
                                <div style="display: flex; justify-content: space-between;">
                                    <h4 class="p-0 mb-10">Mass Application Form</h4>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md">
                                                ...
                                                <?php
                                                    $receiptPath = $data[0]["reciept"];
                                                    $hiddenValue = str_repeat('Receipt', 1);
                                                ?>
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary" type="button"
                                                            data-toggle="modal"
                                                            data-target="#receiptModal">View</button>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    if (!empty($receiptPath)) {
                        echo '<img src="' . htmlspecialchars($receiptPath, ENT_QUOTES, 'UTF-8') . '" alt="Receipt" class="img-fluid">';
                    } else {
                            ...
                            <div class="card-body">
                                ...
                                <ul class="timeline">
                                    ...
                                    <li <?php if ($status >= 2) echo 'class="active"'; ?>>
                                        ...
                                        <p>Your Application <strong
                                                style="color: #007bff"><?php echo $orderId; ?></strong>
                                            was approved. The admin will sent the mass to the Parishioner.</p>
                                        <p class="text-muted">
                                            <?php if (!empty($notification_dates[0])) echo date('M d, Y g:ia', strtotime($notification_dates[0])); ?>
                                    </li>
